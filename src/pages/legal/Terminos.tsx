...
const Terminos = () => (
  <PageLayout title="Términos y Condiciones" subtitle="Última actualización: 30 de mayo de 2026">
    <Section title="1. Identificación del prestador">
      <p><strong>[Nombre de la Empresa]</strong>, [CIF/NIF], con domicilio social en [Dirección postal de la empresa], titular del servicio Carta.</p>
    </Section>
    ...
    <Section title="5. Propiedad intelectual">
      <p>Todos los elementos del servicio (software, diseño, marca) son propiedad de [Nombre de la Empresa] o de sus licenciantes. El contenido cargado por el restaurante sigue siendo de su propiedad.</p>
    </Section>
    <Section title="6. Responsabilidad">
      <p>[Nombre de la Empresa] no se hace responsable de los daños derivados del uso indebido del servicio o de la indisponibilidad puntual del mismo por causas técnicas o de fuerza mayor.</p>
    </Section>
    <Section title="7. Legislación y jurisdicción">
      <p>Estos términos se rigen por la legislación aplicable en el domicilio del prestador. Para cualquier controversia, las partes se someten a los tribunales competentes de dicha jurisdicción.</p>
    </Section>
  </PageLayout>
);
