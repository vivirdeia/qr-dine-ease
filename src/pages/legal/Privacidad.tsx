...
const Privacidad = () => (
  <PageLayout title="Política de Privacidad" subtitle="Última actualización: 30 de mayo de 2026">
    <Section title="1. Responsable del tratamiento">
      ...
      <p>Contacto: privacidad@carta.app</p>
    </Section>
    ...
    <Section title="6. Derechos">
      <p>Puede ejercer sus derechos de acceso, rectificación, supresión, oposición, limitación y portabilidad enviando un email a privacidad@carta.app acompañado de copia de un documento identificativo.</p>
    </Section>
